...
task_23_bp = Blueprint('task_23_bp', __name__, url_prefix='/task_23_word_write_from_video', template_folder='templates')
...
def render(task_id):
    ...
    return render_template('tasks/23_word_write_from_video.html',
