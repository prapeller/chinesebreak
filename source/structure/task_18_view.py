...
task_18_bp = Blueprint('task_18_bp', __name__, url_prefix='/task_18_dialog_B_puzzle_char_from_char',
                       template_folder='templates')


@flask_sijax.route(task_18_bp, '<int:task_id>/', methods=["GET", "POST"])
def render(task_id):
    ...
    return render_template('tasks/18_dialog_B_puzzle_char_from_char.html',
