...
from source.structure.forms import UploadSentAAudioForm, UploadSentBAudioForm, ButtonAddWordForm, ButtonAddGrammarForm, ButtonDeleteForm, \
    BackButtonForm, RightSentAForm, RightSentBForm
from source.static.media_handler import add_to_task_sent_B_audio, add_to_task_sent_A_audio

task_17_bp = Blueprint('task_17_bp', __name__, url_prefix='/task_17_dialog_A_puzzle_char_from_char', template_folder='templates')


@flask_sijax.route(task_17_bp, '<int:task_id>/', methods=["GET", "POST"])
def render(task_id):
    ...
    return render_template('tasks/17_dialog_A_puzzle_char_from_char.html',
