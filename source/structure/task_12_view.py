...
task_12_bp = Blueprint('task_12_bp', __name__, url_prefix='/task_12_sent_paste_from_char', template_folder='templates')


@flask_sijax.route(task_12_bp, '<int:task_id>/', methods=["GET", "POST"])
def render(task_id):
    ...
    return render_template('tasks/12_sent_paste_from_char.html',
