...
task_14_bp = Blueprint('task_14_bp', __name__, url_prefix='/task_14_sent_delete_from_char', template_folder='templates')


@flask_sijax.route(task_14_bp, '<int:task_id>/', methods=["GET", "POST"])
def render(task_id):
    ...
    return render_template('tasks/14_sent_delete_from_char.html',
