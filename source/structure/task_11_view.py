...
task_11_bp = Blueprint('task_11_bp', __name__, url_prefix='/task_11_sent_say_from_video', template_folder='templates')


@flask_sijax.route(task_11_bp, '<int:task_id>/', methods=["GET", "POST"])
def render(task_id):
    ...
    return render_template('tasks/11_sent_say_from_video.html',
                           ...
                           words=words, video_name=video_name,
