...
task_19_bp = Blueprint('task_19_bp', __name__, url_prefix='/task_19_puzzle_char_from_lang', template_folder='templates')


@flask_sijax.route(task_19_bp, '<int:task_id>/', methods=["GET", "POST"])
def render(task_id):
    ...
    return render_template('tasks/19_puzzle_char_from_lang.html',
