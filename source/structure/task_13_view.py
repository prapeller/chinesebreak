...
task_13_bp = Blueprint('task_13_bp', __name__, url_prefix='/task_13_sent_choose_from_char', template_folder='templates')


@flask_sijax.route(task_13_bp, '<int:task_id>/', methods=["GET", "POST"])
def render(task_id):
    ...
    return render_template('tasks/13_sent_choose_from_char.html',
